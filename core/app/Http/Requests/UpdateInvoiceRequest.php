...
class UpdateInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'rental_end_date' => ['required_if:order_type,rental', 'nullable', 'date', 'after_or_equal:rental_start_date'],
            'delivery_time' => ['required_if:order_type,rental', 'nullable', 'date_format:H:i'],
            'return_time' => ['required_if:order_type,rental', 'nullable', 'date_format:H:i'],
    ...
    public function messages(): array
    {
        return [
            ...
            'rental_end_date.required_if' => 'Rental end date is required for rental orders.',
            'rental_end_date.after_or_equal' => 'Rental end date must be on or after the start date.',
            'delivery_time.required_if' => 'Delivery time is required for rental orders.',
            'return_time.required_if' => 'Return time is required for rental orders.',
