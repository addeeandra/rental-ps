        ...
        <DialogContent class="sm:max-w-[600px]">
            ...
            <div class="space-y-4">
                ...
                <Alert>
                    ...
                    <AlertDescription class="text-sm">
                        ...
                        <ul class="mt-2 list-inside list-disc space-y-1">
                            ...
                            <li>Category codes will be auto-generated</li>
                        </ul>
                        <a
                            href="/categories/template"
                ...
                >
                    ...
                    <p class="text-sm font-medium">Importing categories...</p>
                </div>
                    ...
                    <AlertDescription>
                        <div class="space-y-2">
                            <p class="font-semibold">
                                ...
                                {{ importResult.summary.total }} categories.
                                <span
