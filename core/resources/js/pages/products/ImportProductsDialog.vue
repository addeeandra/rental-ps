        ...
        <DialogContent class="sm:max-w-[600px]">
            ...
            <div class="space-y-4">
                ...
                <Alert>
                    ...
                    <AlertDescription class="text-sm">
                        ...
                        <ul class="mt-2 list-inside list-disc space-y-1">
                            ...
                            <li>
                                Required fields: Name, Category, Sales Price,
                                Rental Price, UOM, Rental Duration
                            </li>
                            <li>
                                Categories will be auto-created if they don't
                                exist
                            </li>
                            <li>Rental duration: hour, day, week, or month</li>
                        </ul>
                        <a
                ...
                >
                    ...
                    <p class="text-sm font-medium">Importing products...</p>
                </div>
                    ...
                    <AlertDescription>
                        <div class="space-y-2">
                            <p class="font-semibold">
                                ...
                                {{ importResult.summary.total }} products.
                                <span
